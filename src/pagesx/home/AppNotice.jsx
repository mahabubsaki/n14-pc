        ...
        <section className="py-6 ">
            <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                <div className="flex flex-col justify-center lg:text-left">
                    <h1 className="py-2 text-2xl font-medium uppercase ">News 24 Mobile App</h1>
                    <p className="mb-1 text-lg font-medium text-primary">You can get this app also for your mobile device</p>
                ...
                <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
                    <button className="inline-flex items-center px-6 py-3 rounded-lg bg-accent">
                    ...
                    <button className="inline-flex items-center px-5 py-3 rounded-lg bg-secondary ">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="fill-current w-7 h-7">
