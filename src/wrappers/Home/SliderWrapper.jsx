...
import SliderArticle from '@/pages/home/SliderArticle';
import hydrateData from '@/utils/hydrateData';
import React from 'react';

const SliderWrapper = async () => {
    await dbConnect();
    const articles = await Article.find().select({ createdAt: 1, title: 1, image: 1, views: 1 }).populate('authorId', { username: 1, _id: 0, avatar: 1 });
